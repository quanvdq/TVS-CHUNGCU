...
namespace TVSReports
{
    ...
    public partial class rptPaymentVoucherListTotal : DataDynamics.ActiveReports.ActiveReport3
    {        
        ...
        #region method rptPaymentVoucherListTotal
        public rptPaymentVoucherListTotal()
        {
            InitializeComponent();
        ...
        {
            sIndexGroup ++;
            this.TxtIndex.Text = sIndexGroup.ToString(); 
        }
